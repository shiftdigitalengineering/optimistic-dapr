...
namespace Dapr.Client
{
    public static class DaprClientExtensions
    {
        ...
        public static async Task<bool> TrySaveSetStateAsync<TValue>(this DaprClient daprClient, string storeName, string key, Func<HashSet<TValue>, Task<HashSet<TValue>>> setFactory, short retryAttempts = 1, short retryWaitTimeInSeconds = 5, CancellationToken cancellationToken = default)
        {
